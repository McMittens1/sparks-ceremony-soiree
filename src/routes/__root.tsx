...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The wedding of Geovanni Moreno & Addison Hillman — October 10, 2026 in Louisville, Nebraska. Details, travel, and RSVP." },
      { property: "og:title", content: "Geovanni & Addison · October 10, 2026" },
      { property: "og:description", content: "Join us in Louisville, Nebraska on October 10, 2026." },
