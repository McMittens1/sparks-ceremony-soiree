...
- **Open item found during that pass:** `ADMIN_NOTIFICATION_EMAILS` currently resolves to `noreply@notify.morenowedding2026.com`, so admin RSVP alerts are being delivered to the sending mailbox rather than to a person. Point it at the couple's real inbox before invitations go out.
